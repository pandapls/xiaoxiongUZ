		...
		<div class="section">
			<div class="leftBox">
				<ul>
					<li>
						...
						<p id="active" @click="address">公司地址</p>
			...
			<div class="rightBox">
				...
				<div class="headquarters">
					<div class="headTit">公司总部</div>
					<div class="map">
						<img src="../../assets/aboutUs/map.png" />
					</div>
					<p class="address">地址：深圳市福田区凯丰路国际金融科技城5层&6层</p>
					<p class="tellphone">售前热线：400-678-5432</p>
				</div>
			</div>
		</div>
	</div>
