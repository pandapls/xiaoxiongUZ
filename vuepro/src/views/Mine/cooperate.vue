      ...
      <div class="leftBox">
        <ul>
          ...
          <li>
            ...
            <p id="active" @click="cooperate">商业合作</p>
          </li>
        </ul>
      </div>
      <div class="rightBox">
        <p class="rightTittle">商业合作</p>
        <div class="boxContent">
          ...
          <div class="imgcontact">
            <img src="https://www.bearrental.com/build/img/aboutUs/bg_businessCooperation.png" alt />
          </div>
        </div>
      </div>
    </div>
...
.mine{
	...
	.rightBox {
		...
		margin-left: 20px;
		padding-bottom: 30px;
		background-image: url(../../assets/aboutUs/titleBg_businessCooperation.png);
			...
			.userEmail {
				...
				li {
					...
					.imguser {
						width: 45px;
						height: 56px;
						background: url(../../assets/aboutUs/spirit.png) -196px 0 no-repeat no-repeat;
					}
					.imgemail {
						width: 63px;
						height: 45px;
						margin-left: 28px;
						background: url(../../assets/aboutUs/spirit.png) -299px 0 no-repeat no-repeat;
					}
				}
			}
			.imgcontact{
