    ...
    <section class="conter">
      <div class="conter-left">
        <div class="conter-left-txt">
          ...
          <router-link to="/login" class="login-register-soon">立即登录</router-link>
        </div>
      </div>
      <div class="conter-right">
        <div class="head">
          <div class="fl">欢迎登录</div>
          <div class="fr">
            已有账号？
        ...
        <div class="userName-login">
          ...
          >
            ...
            <el-form-item label="图形验证码" prop="identify">
              <el-input
                type="text"
              ...
              ></el-input>
              <div class="potoCode" @click="changeCode()">
  ...
  data() {
    ...
    var validatePass2 = (rule, value, callback) => {
      ...
      if (value === "") {
        ...
        callback(new Error("密码8-32位数字和字母组成"));
      } else {
        callback();
      }
    };
